          ...
          <CardTitle className="flex items-center justify-between">
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="max-w-2xl">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setFormData(prev => ({ ...prev, visitor_phone: digits }));
                        }}
                ...
                <Input
                  id="visitor_id_proof"
                  placeholder="Aadhar / Passport / License"
                  value={formData.visitor_id_proof}
                  onChange={(e) => setFormData(prev => ({ ...prev, visitor_id_proof: e.target.value }))}
                  pattern="^([0-9]{12}|[A-PR-WYa-pr-wy][1-9][0-9]\s?[0-9]{4}\s?[0-9]{4}|[A-Z]{2}[0-9]{2}[0-9]{11})$"
                  title="Enter a valid Aadhar (12 digits), Passport (ex: K1234567), or Driving License (ex: DL0420110149646)"
                  required
                />
              </div>
